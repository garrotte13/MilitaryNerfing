...
data:extend({
    ...
    -- taken from the mod https://mods.factorio.com/mod/TreeSeeds
    {
		...
		name = "mn-sapling",
		subgroup = "terrain",
		icon = "__MilitaryNerfing__/graphics/saplings/icon_sapling.png",
		icon_size = 32,
		stack_size = 50,
	...
	},
    {
      ...
      picture = {
        filename = '__MilitaryNerfing__/graphics/saplings/plant-stick.png',
        priority = 'extra-high',
        width = 123,
        height = 123,
        shift = { 0.6, -1.4 }
...

    {
        type = "item",
        name = "mn-greenhouse",
        icon = "__MilitaryNerfing__/graphics/gh/greenhouse-icon.png",
        icon_size = 64,
    ...
    fluid_boxes = {
        {
            ...
            pipe_picture = {
                ...
                south = {
                  filename = "__MilitaryNerfing__/graphics/gh/pipe-patch.png",
                  priority = "high",
                  width = 55,
                  height = 50,
                  scale = 0.5,
    ...
    working_sound = {
        sound = {
          filename = "__MilitaryNerfing__/sounds/greenhouse-watering_16s.ogg",
          volume = 0.95,
          aggregation = {
            max_count = 1,
            remove = false,
    ...
    graphics_set = {
        working_visualisations = {
            {
                ...
                animation = {
                    stripes = {
                        {
                            filename = "__MilitaryNerfing__/graphics/gh/greenhouse-hr-emission-1.png",
                            width_in_frames = 8,
                            height_in_frames = 8
                        },
                        {
                            filename = "__MilitaryNerfing__/graphics/gh/greenhouse-hr-emission-2.png",
                            width_in_frames = 8,
                            height_in_frames = 8
                        }
                    },
            ...
            },
            {
                ...
                animation = {
                    stripes = {
                        {
                            filename = "__MilitaryNerfing__/graphics/gh/greenhouse-hr-color3-1.png",
                            width_in_frames = 8,
                            height_in_frames = 8
                        },
                        {
                            filename = "__MilitaryNerfing__/graphics/gh/greenhouse-hr-color3-2.png",
                            width_in_frames = 8,
                            height_in_frames = 8
                        }
                    },
        ...
        animation = {
            north = {
                layers = {
                    {
                        filename = "__MilitaryNerfing__/graphics/gh/greenhouse-hr-shadow.png",
                        priority = "high",
                        width = 700,
                        height = 500,
                        frame_count = 1,
                    ...
                    },
                    {
                        stripes = {
                            {
                                filename = "__MilitaryNerfing__/graphics/gh/greenhouse-hr-animation-1.png",
                                width_in_frames = 8,
                                height_in_frames = 8
                            },
                            {
                                filename = "__MilitaryNerfing__/graphics/gh/greenhouse-hr-animation-2.png",
                                width_in_frames = 8,
                                height_in_frames = 8
                            }
                        },
    ...
    },
    {
        ...
        icon = "__MilitaryNerfing__/graphics/remnants-icon.png",
        icon_size = 64,
        ...
        animation = make_rotated_animation_variations_from_sheet(1, {
          filename = "__MilitaryNerfing__/graphics/big-random-pipes-remnants.png",
            line_length = 1,
            width = 500,
            height = 500,
            frame_count = 1,
...

    {
        type = "technology",
        name = "mn-saplings",
        icon = "__MilitaryNerfing__/graphics/gh/greenhouse-icon-big.png",
        icon_size = 640,
        prerequisites = {
